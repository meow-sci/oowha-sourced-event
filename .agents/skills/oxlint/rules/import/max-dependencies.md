...
{
  "rules": {
    "import/max-dependencies": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/max-dependencies.md)
