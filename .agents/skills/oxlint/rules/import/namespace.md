...
type_aware: false
fix: "none"
upstream: "https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/namespace.md"
---
...
{
  "rules": {
    "import/namespace": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/namespace.md)
