...
{
  "rules": {
    "import/no-named-as-default": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/no-named-as-default.md)
