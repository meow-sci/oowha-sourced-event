...
{
  "rules": {
    "import/newline-after-import": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/import-js/eslint-plugin-import/blob/main/docs/rules/newline-after-import.md)
