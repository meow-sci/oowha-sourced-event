...
{
  "rules": {
    "vitest/no-focused-tests": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/no-focused-tests.md)
