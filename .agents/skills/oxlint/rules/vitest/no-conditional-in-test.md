...
{
  "rules": {
    "vitest/no-conditional-in-test": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/no-conditional-in-test.md)
