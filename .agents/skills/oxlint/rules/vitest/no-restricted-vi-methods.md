...
{
  "rules": {
    "vitest/no-restricted-vi-methods": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/no-restricted-vi-methods.md)
