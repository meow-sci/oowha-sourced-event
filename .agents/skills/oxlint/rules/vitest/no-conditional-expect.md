...
{
  "rules": {
    "vitest/no-conditional-expect": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/no-conditional-expect.md)
