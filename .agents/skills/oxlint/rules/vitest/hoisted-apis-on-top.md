...
{
  "rules": {
    "vitest/hoisted-apis-on-top": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/vitest-dev/eslint-plugin-vitest/blob/main/docs/rules/hoisted-apis-on-top.md)
