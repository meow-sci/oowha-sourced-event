...
type_aware: false
fix: "none"
upstream: "https://nextjs.org/docs/messages/no-unwanted-polyfillio"
---
...
{
  "rules": {
    "nextjs/no-unwanted-polyfillio": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://nextjs.org/docs/messages/no-unwanted-polyfillio)
