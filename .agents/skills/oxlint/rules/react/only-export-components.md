...
{
  "rules": {
    "react/only-export-components": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/ArnaudBarre/eslint-plugin-react-refresh/blob/main/docs/only-export-components.md)
