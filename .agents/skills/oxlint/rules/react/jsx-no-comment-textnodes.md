...
{
  "rules": {
    "react/jsx-no-comment-textnodes": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-no-comment-textnodes.md)
