...
type_aware: false
fix: "pending"
upstream: "https://github.com/eslint-community/eslint-plugin-promise/blob/main/docs/rules/no-return-wrap.md"
---
...
{
  "rules": {
    "promise/no-return-wrap": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/eslint-community/eslint-plugin-promise/blob/main/docs/rules/no-return-wrap.md)
