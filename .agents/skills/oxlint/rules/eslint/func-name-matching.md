...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/func-name-matching"
---
...
{
  "rules": {
    "eslint/func-name-matching": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/func-name-matching)
