...
type_aware: false
fix: "pending"
upstream: "https://eslint.org/docs/latest/rules/no-fallthrough"
---
...
{
  "rules": {
    "eslint/no-fallthrough": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-fallthrough)
