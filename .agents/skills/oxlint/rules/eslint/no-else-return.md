...
type_aware: false
fix: "conditional_fix"
upstream: "https://eslint.org/docs/latest/rules/no-else-return"
---
...
{
  "rules": {
    "eslint/no-else-return": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-else-return)
