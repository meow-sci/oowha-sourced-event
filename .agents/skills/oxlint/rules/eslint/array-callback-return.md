...
type_aware: false
fix: "pending"
upstream: "https://eslint.org/docs/latest/rules/array-callback-return"
---
...
{
  "rules": {
    "eslint/array-callback-return": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/array-callback-return)
