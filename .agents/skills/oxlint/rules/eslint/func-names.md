...
upstream: "https://eslint.org/docs/latest/rules/func-names"
---
...
{
  "rules": {
    "eslint/func-names": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/func-names)
