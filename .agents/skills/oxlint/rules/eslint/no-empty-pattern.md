...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/no-empty-pattern"
---
...
{
  "rules": {
    "eslint/no-empty-pattern": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-empty-pattern)
