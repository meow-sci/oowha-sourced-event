...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/no-inline-comments"
---
...
{
  "rules": {
    "eslint/no-inline-comments": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-inline-comments)
