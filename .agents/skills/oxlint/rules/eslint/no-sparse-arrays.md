...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/no-sparse-arrays"
---
...
{
  "rules": {
    "eslint/no-sparse-arrays": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-sparse-arrays)
