...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/no-self-assign"
---
...
{
  "rules": {
    "eslint/no-self-assign": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/no-self-assign)
