...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/accessor-pairs"
---
...
{
  "rules": {
    "eslint/accessor-pairs": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/accessor-pairs)
