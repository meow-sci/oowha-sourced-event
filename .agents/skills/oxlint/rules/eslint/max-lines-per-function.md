...
type_aware: false
fix: "none"
upstream: "https://eslint.org/docs/latest/rules/max-lines-per-function"
---
...
{
  "rules": {
    "eslint/max-lines-per-function": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://eslint.org/docs/latest/rules/max-lines-per-function)
