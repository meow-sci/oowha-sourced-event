...
{
  "rules": {
    "jest/no-large-snapshots": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://github.com/jest-community/eslint-plugin-jest/blob/main/docs/rules/no-large-snapshots.md)
