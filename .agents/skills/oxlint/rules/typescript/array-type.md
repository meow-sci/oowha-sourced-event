...
type_aware: false
fix: "fixable_fix"
upstream: "https://typescript-eslint.io/rules/array-type/"
---
...
{
  "rules": {
    "typescript/array-type": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/array-type/)
