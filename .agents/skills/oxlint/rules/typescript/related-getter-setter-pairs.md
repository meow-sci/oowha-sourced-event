...
type_aware: true
fix: "none"
upstream: "https://typescript-eslint.io/rules/related-getter-setter-pairs/"
---
...
{
  "rules": {
    "typescript/related-getter-setter-pairs": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/related-getter-setter-pairs/)
