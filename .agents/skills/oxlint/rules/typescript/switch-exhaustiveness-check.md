...
upstream: "https://typescript-eslint.io/rules/switch-exhaustiveness-check/"
---
...
{
  "rules": {
    "typescript/switch-exhaustiveness-check": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/switch-exhaustiveness-check/)
