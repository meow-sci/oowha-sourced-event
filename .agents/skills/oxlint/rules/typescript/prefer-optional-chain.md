...
upstream: "https://typescript-eslint.io/rules/prefer-optional-chain/"
---
...
{
  "rules": {
    "typescript/prefer-optional-chain": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/prefer-optional-chain/)
