...
type_aware: true
fix: "fixable_fix"
upstream: "https://typescript-eslint.io/rules/no-unnecessary-type-assertion/"
---
...
{
  "rules": {
    "typescript/no-unnecessary-type-assertion": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-unnecessary-type-assertion/)
