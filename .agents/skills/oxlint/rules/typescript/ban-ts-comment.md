...
type_aware: false
fix: "conditional_fix"
upstream: "https://typescript-eslint.io/rules/ban-ts-comment/"
---
...
{
  "rules": {
    "typescript/ban-ts-comment": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/ban-ts-comment/)
