...
type_aware: false
fix: "none"
upstream: "https://typescript-eslint.io/rules/no-namespace/"
---
...
{
  "rules": {
    "typescript/no-namespace": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-namespace/)
