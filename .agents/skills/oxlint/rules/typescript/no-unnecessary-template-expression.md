...
type_aware: true
fix: "fixable_fix"
upstream: "https://typescript-eslint.io/rules/no-unnecessary-template-expression/"
---
...
{
  "rules": {
    "typescript/no-unnecessary-template-expression": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-unnecessary-template-expression/)
