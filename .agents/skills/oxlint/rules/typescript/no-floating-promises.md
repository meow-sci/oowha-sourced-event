...
upstream: "https://typescript-eslint.io/rules/no-floating-promises/"
---
...
{
  "rules": {
    "typescript/no-floating-promises": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-floating-promises/)
