...
type_aware: false
fix: "fixable_fix"
upstream: "https://typescript-eslint.io/rules/prefer-ts-expect-error/"
---
...
{
  "rules": {
    "typescript/prefer-ts-expect-error": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/prefer-ts-expect-error/)
