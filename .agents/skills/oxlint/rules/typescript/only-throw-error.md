...
type_aware: true
fix: "none"
upstream: "https://typescript-eslint.io/rules/only-throw-error/"
---
...
{
  "rules": {
    "typescript/only-throw-error": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/only-throw-error/)
