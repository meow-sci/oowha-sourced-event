...
type_aware: false
fix: "none"
upstream: "https://typescript-eslint.io/rules/triple-slash-reference/"
---
...
{
  "rules": {
    "typescript/triple-slash-reference": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/triple-slash-reference/)
