...
type_aware: true
fix: "none"
upstream: "https://typescript-eslint.io/rules/no-deprecated/"
---
...
{
  "rules": {
    "typescript/no-deprecated": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-deprecated/)
