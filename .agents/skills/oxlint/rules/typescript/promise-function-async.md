...
type_aware: true
fix: "conditional_fix"
upstream: "https://typescript-eslint.io/rules/promise-function-async/"
---
...
{
  "rules": {
    "typescript/promise-function-async": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/promise-function-async/)
