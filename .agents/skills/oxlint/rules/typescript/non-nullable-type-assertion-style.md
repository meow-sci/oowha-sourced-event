...
upstream: "https://typescript-eslint.io/rules/non-nullable-type-assertion-style/"
---
...
{
  "rules": {
    "typescript/non-nullable-type-assertion-style": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/non-nullable-type-assertion-style/)
