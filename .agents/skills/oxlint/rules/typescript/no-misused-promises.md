...
type_aware: true
fix: "none"
upstream: "https://typescript-eslint.io/rules/no-misused-promises/"
---
...
{
  "rules": {
    "typescript/no-misused-promises": ["error", { /* options */ }]
  }
}
```
...
- [Upstream rule documentation](https://typescript-eslint.io/rules/no-misused-promises/)
