...
> **Note:** This document describe the native LSP options for `oxlint`. Depending on your editor, you may have different options.
> See [Editor setup](./editors.md) to configure your editor options.
