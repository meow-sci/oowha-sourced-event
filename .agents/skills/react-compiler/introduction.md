...
React Compiler can be installed across [several build tools](./installation.md) such as Babel, Vite, Metro, and Rsbuild.
...
* **[Installation](./installation.md)** - Install React Compiler and configure it for your build tools
...
* **[Incremental Adoption](./incremental-adoption.md)** - Strategies for gradually rolling out the compiler in existing codebases
* **[Debugging and Troubleshooting](./debugging.md)** - Identify and fix issues when using the compiler
