...
See [migrate from prettier](migrate-from-prettier.md) for details.
...
This is useful for configuring [files to ignore](ignore-files.md).
...
- [Change configuration](config.md)
- [Setup editors](editors.md)
- [Setup CI](ci.md)
- Learn advanced features: [sorting](sorting.md), [embedded formatting](embedded-formatting.md)
