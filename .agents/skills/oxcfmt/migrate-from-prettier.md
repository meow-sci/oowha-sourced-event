...
- Some options are not supported (see [config reference](config-file-reference.md))

See [Unsupported features](unsupported-features.md) for details on unsupported features.
