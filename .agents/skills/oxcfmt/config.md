...
- [Ignore files](ignore-files.md): Ignore files and patterns, `.gitignore` and `.prettierignore` workflows.
- [Inline ignore comments](ignore-comments.md): Inline suppressions for specific code.
- [Config file reference](config-file-reference.md): Full schema and field documentation.
- [CLI reference](cli.md): Complete list of flags.
